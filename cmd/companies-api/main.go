...
import (
	...
	"companies-service/internal/server"
	"companies-service/pkg/db/postgres"
	"companies-service/pkg/db/redis"
...
// @contact.name Anargyros Plemenos
// @contact.url https://github.com/aplemenos
// @contact.email anargyros.plemenos@gmail.com
// @BasePath /api/v1
func main() {
	log.Println("Starting company api server")
