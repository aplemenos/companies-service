...
// HashPassword hashes user password with bcrypt
...
// ComparePasswords compares user password and payload
...
// SanitizePassword sanitizes user password
func (u *User) SanitizePassword() {
	u.Password = ""
}

// PrepareCreate prepares user for register
...
// PrepareUpdate prepares user for register
